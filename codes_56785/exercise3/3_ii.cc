...
std::string fileNameRoot = "3_ii";    // base name for trace files, etc
...
//  Config::SetDefault ("ns3::RttEstimator::MinRTO", TimeValue (MilliSeconds (500)));
  ...
  Config::SetDefault ("ns3::RedQueueDisc::MaxTh", DoubleValue (18));
  /*--------------------------------------------------------------*/
